      ...
      <div className="relative z-10">
        <div className="flex flex-wrap justify-center gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="bg-gray-900 rounded-lg w-72 overflow-hidden transform transition-transform hover:scale-105 border border-gray-800">
                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, i) => (
                      <span key={i} className="bg-gray-800 text-green-500 px-2 py-1 rounded-full text-xs border border-green-500">
                        {tech}
                      </span>
                    ))}
                  </div>
